...
class NearHotelDetail extends StatefulWidget {
 Hotel? hotel;
  ...
  @override
  _NearHotelDetailState createState() => _NearHotelDetailState();
}

class _NearHotelDetailState extends State<NearHotelDetail> {
  /// Check user
